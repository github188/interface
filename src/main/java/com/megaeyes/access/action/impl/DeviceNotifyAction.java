...
/**
 * 设备故障报警，不再使用，保证接入正确返回就行
 * 
 * @author huangbuji huangbuji@megaeyes.com
 *         <p />
 *         2012-7-17 下午01:40:13
 */
public class DeviceNotifyAction extends BaseAction implements Action {

	private static final Log log = LogFactory.getLog(DeviceNotifyAction.class);

	public Document proccess(RequestObject req) throws BusinessException {
		log.info("In DeviceNotifyAction...");
