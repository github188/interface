...
/**
 * 报警通知，没有用到，保证接入正确返回就行
 * 
 * @author huangbuji huangbuji@megaeyes.com
 *         <p />
 *         2012-7-13 上午09:14:11
 */
public class AlarmInfoAction extends BaseAction implements Action {

	private static final Log log = LogFactory.getLog(AlarmInfoAction.class);

	public Document proccess(RequestObject req) throws BusinessException {
		log.info("In AlarmInfoAction...");
