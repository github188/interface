...
public class AlarmOutputChannelType implements Serializable {
    /**
     * ALARM_OUTPUT_CHANNEL_TYPE.ID
     * null
     */
    private String id;

    /**
     * ALARM_OUTPUT_CHANNEL_TYPE.OPTIMISTIC_LOCK
     * null
     */
    private BigDecimal optimisticLock;

    /**
     * ALARM_OUTPUT_CHANNEL_TYPE.F_NAME
     * null
     */
    private String name;

    /**
     * ALARM_OUTPUT_CHANNEL_TYPE.IS_CONTROLLABLE_BY_USER
     * null
     */
    private Short isControllableByUser;

    /**
     * ALARM_OUTPUT_CHANNEL_TYPE.DESCRIBE
     * null
     */
