...
public class AlarmInputChannelTypeExample {
    protected String orderByClause;

    protected List oredCriteria;

    public AlarmInputChannelTypeExample() {
        oredCriteria = new ArrayList();
    }

    protected AlarmInputChannelTypeExample(AlarmInputChannelTypeExample example) {
