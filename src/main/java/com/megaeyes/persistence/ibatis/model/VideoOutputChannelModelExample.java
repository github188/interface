...
public class VideoOutputChannelModelExample {
    protected String orderByClause;

    protected List oredCriteria;

    public VideoOutputChannelModelExample() {
        oredCriteria = new ArrayList();
    }

    protected VideoOutputChannelModelExample(VideoOutputChannelModelExample example) {
